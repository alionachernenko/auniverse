...
const schema = yup.object().shape({
  email: yup
    ...
    .matches(
      /^[\w-.]+@([\w-]+\.)+[\w-]{2,4}$/,
      'Please, provide a valid email (ex: john@company.com)'
    )
  ...
  password: yup
    ...
    .matches(
      /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,32}$/,
      'Password must be at least 8 characters, no more than 32 characters, and contain at least one upper case letter, one lower case letter, and one numeric digit'
    )
